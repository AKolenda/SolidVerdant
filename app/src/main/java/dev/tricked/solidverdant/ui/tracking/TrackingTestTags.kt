...
object TrackingTestTags {
    ...
    const val OPEN_CALENDAR_BUTTON = "track_open_calendar"
    const val OPEN_REVIEW_BUTTON = "track_open_review"
    ...
    const val SHEET_TAGS_SELECTOR = dev.tricked.solidverdant.ui.components.EditTimeEntryTestTags.TAGS_SELECTOR
    const val SHEET_TAGS_LIST = dev.tricked.solidverdant.ui.components.EditTimeEntryTestTags.TAGS_LIST
    const val SHEET_TAGS_CLOSE = dev.tricked.solidverdant.ui.components.EditTimeEntryTestTags.TAGS_CLOSE
